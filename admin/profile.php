                                ...
                                <!--<div class="row">
                                    <div class="col-md-6">!-->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="branch_name" id="branch_name" class="form-control" required  data-parsley-trigger="keyup" />
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="branch_contact_no" id="branch_contact_no" class="form-control" required  data-parsley-trigger="keyup" />
                                        </div>
                                        <div class="form-group">
                                            <label>Profile Pic</label><br />
                                            <input type="file" name="branch_logo" id="branch_logo" />
                                            <span id="uploaded_branch_logo"></span>
                                        </div>
                                    <!--</div>
                                </div>!-->
                            </div>
