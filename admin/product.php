    	...
    	<form method="post" id="product_form">
      		<div class="modal-content">
        		...
        		<div class="modal-body">
					...
					<div class="form-group">
		          		<label>Product Purpose </label><span class="text-danger">*</span>
		          		<input type="text" name="product_purpose" id="product_purpose" class="form-control" required data-parsley-pattern="/^[a-zA-Z0-9 \s]+$/" data-parsley-trigger="keyup" rows="5"/>
		          	</div>
					  <div class="form-group">
		          		<label>Product Prescription </label><span class="text-danger">*</span>
		          		<textarea name="product_prescription" id="product_prescription" class="form-control" required rows="5"></textarea>
		          	</div>
					<div class="form-group">
                        <label>Product Instruction </label><span class="text-danger">*</span>
                        <textarea name="product_direction" id="product_direction" class="form-control" required rows="5"></textarea>
                    </div>
                    <div class="form-group">
					...
					<!-- <div class="form-group">
                        <label>Product Stock</label><span class="text-danger">*</span>
                        <input type="text" name="product_stock" id="product_stock" class="form-control" required data-parsley-pattern="^[0-9]*$" data-parsley-trigger="keyup" />
                    </div> -->
        		</div>
...
$(document).ready(function(){
	...
	$(document).on('click', '.edit_button', function(){
		...
		$.ajax({
	      	...
	      	success:function(data)
	      	{
	        	...
	        	$('#product_direction').val(data.product_direction);
				...
				$('#product_purpose').val(data.product_purpose);

				$('#product_prescription').val(data.product_prescription);
	...
	// 	var next_status = 'In Stock';
	// 	if(status == 'In Stock')
	// 	{
	// 		next_status = 'Out of Stock';
	// 	}
